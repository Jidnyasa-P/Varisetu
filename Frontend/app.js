...
/* ============================================================================
   VariSetu — Marathi / English UI Language Toggle
   ----------------------------------------------------------------------------
   Purely additive: this block does not modify, wrap, or call any of the
   existing functions/variables above it. It only reads the DOM after it has
   been rendered and swaps matching text for its Marathi translation.

   How it works:
   - VARISETU_I18N_DICT maps exact English UI strings -> Marathi strings.
   - On toggle, a TreeWalker scans visible text nodes (skipping <script>,
     <style>, <textarea>, <code>, <pre>) and swaps any node whose trimmed
     text exactly matches a dictionary key. placeholder/title/aria-label
     attributes are handled the same way.
   - A MutationObserver re-applies the current language to any new DOM the
     app injects later (CCTV cards, alert lists, modals, etc.), so dynamically
     rendered screens get translated too, without editing every render
     function individually.
   - Original English text is cached the first time a node is touched, so
     switching back to English is lossless.
   - The language choice is remembered in localStorage; default is English.

   To translate more UI text later, just add another "English": "मराठी"
   entry to VARISETU_I18N_DICT below — no HTML changes needed.
   ============================================================================ */
(function () {
  var VARISETU_I18N_DICT = {
  "COMMAND CENTER ACCESS": "कमांड सेंटर प्रवेश",
  "Official Email / Officer ID": "अधिकृत ईमेल / अधिकारी आयडी",
  "Password": "पासवर्ड",
  "SIGN IN": "साइन इन",
  "Public Pilgrim Portal & Helplines (नागरिक माहिती)": "सार्वजनिक यात्रेकरू पोर्टल आणि हेल्पलाइन",
  "Authorised Personnel Only • Access Monitored": "केवळ अधिकृत कर्मचाऱ्यांसाठी • प्रवेशावर नजर ठेवली जाते",
  "PALKHI: APPROACHING WAKHRI": "पालखी: वाखरीच्या दिशेने",
  "Officer Login": "अधिकारी लॉगिन",
  "Live Location: Wakhri Phata Junction (Km 184) • Moving smoothly towards Pandharpur Shrine": "थेट स्थान: वाखरी फाटा जंक्शन (कि.मी. 184) • पंढरपूर मंदिराच्या दिशेने सुरळीत वाटचाल",
  "Estimated Pilgrim Count": "अंदाजे भाविक संख्या",
  "PILGRIMAGE ROUTE & HALT STATIONS MAP": "यात्रा मार्ग आणि मुक्काम स्थानकांचा नकाशा",
  "Alandi → Saswad → Lonand → Wakhri → Pandharpur": "आळंदी → सासवड → लोणंद → वाखरी → पंढरपूर",
  "☀️ PILGRIM HEALTH & HYDRATION ADVISORY": "☀️ भाविक आरोग्य व जलसंजीवन सूचना",
  "34°C MODERATE HEAT": "34°C मध्यम उष्णता",
  "Advisory:": "सूचना:",
  "Drink plenty of water. Free ORSL salt sachets & medical assistance are available at all 24 water points and 16 medical tents stationed along the highway.": "पुरेसे पाणी प्या. महामार्गावरील सर्व 24 पाणी केंद्रे आणि 16 वैद्यकीय शिबिरांमध्ये मोफत ओआरएसएल मीठ पाकिटे व वैद्यकीय मदत उपलब्ध आहे.",
  "EMERGENCY & HELPLINE NUMBERS": "आणीबाणी व हेल्पलाइन क्रमांक",
  "24x7 ACTIVE": "24x7 कार्यरत",
  "Police Control Room (महाराष्ट्र पोलीस)": "पोलीस नियंत्रण कक्ष (महाराष्ट्र पोलीस)",
  "CALL NOW": "आत्ता कॉल करा",
  "Ambulance & Medical Emergency": "रुग्णवाहिका व वैद्यकीय आणीबाणी",
  "Lost & Found Pilgrim Assistance Booth": "हरवले-सापडले भाविक साहाय्य कक्ष",
  "1800-233-0099 (Toll Free)": "1800-233-0099 (टोल फ्री)",
  "Shri Vitthal Mandir Samiti Control Desk": "श्री विठ्ठल मंदिर समिती नियंत्रण कक्ष",
  "REPORT MISSING FAMILY MEMBER": "हरवलेल्या कुटुंब सदस्याची तक्रार नोंदवा",
  "Separated from your family or group in the crowd? Submit details and photos directly for instant AI matching across state CCTV cameras.": "गर्दीत आपल्या कुटुंबापासून किंवा गटापासून ताटातूट झाली आहे का? राज्यभरातील सीसीटीव्ही कॅमेऱ्यांद्वारे तात्काळ एआय जुळणीसाठी तपशील व छायाचित्रे थेट सादर करा.",
  "Submit Missing Person Report (तक्रार नोंदवा)": "हरवलेल्या व्यक्तीची तक्रार नोंदवा",
  "28 JUL 2026 18:50:00 IST": "28 जुलै 2026 18:50:00 IST",
  "PILGRIM COUNT: ~8,45,000": "भाविक संख्या: ~8,45,000",
  "GIS Engine": "जीआयएस इंजिन",
  "Audit Trail": "ऑडिट ट्रेल",
  "SOS Helpline (नागरीक मदत)": "एसओएस हेल्पलाइन (नागरीक मदत)",
  "Alerts": "इशारे",
  "+ Add Officer": "+ अधिकारी जोडा",
  "LOG OUT": "लॉग आउट",
  "Main Command Center": "मुख्य कमांड सेंटर",
  "Crowd Intelligence": "गर्दी विश्लेषण",
  "94% Max Density": "94% कमाल घनता",
  "Lost & Found Desk": "हरवले-सापडले कक्ष",
  "3 Active": "3 सक्रिय",
  "Medical Alerts": "वैद्यकीय इशारे",
  "2 Alerts": "2 इशारे",
  "Resources": "संसाधने",
  "Real-time Operational Command & Surveillance": "रिअल-टाइम कार्यान्वयन नियंत्रण व सर्वेक्षण",
  "Active Surveillance: 4 CCTVs • Route: Alandi - Dehu - Pune - Wakhri - Pandharpur": "सक्रिय सर्वेक्षण: 4 सीसीटीव्ही • मार्ग: आळंदी - देहू - पुणे - वाखरी - पंढरपूर",
  "CROWD DENSITY HEATMAP & CORRIDOR": "गर्दी घनता हीटमॅप व मार्गिका",
  "Density Classification": "घनता वर्गीकरण",
  "Critical (> 85%):": "गंभीर (> 85%):",
  "High Congestion": "तीव्र गर्दी",
  "High Surge (70% - 85%):": "मोठी वाढ (70% - 85%):",
  "Heavy Density": "जास्त घनता",
  "Moderate (50% - 70%):": "मध्यम (50% - 70%):",
  "Steady Flow": "स्थिर प्रवाह",
  "Normal (< 50%):": "सामान्य (< 50%):",
  "Unobstructed Flow": "अबाधित प्रवाह",
  "Wari Pilgrimage Corridors": "वारी यात्रा मार्गिका",
  "Route 1:": "मार्ग 1:",
  "Alandi ➔ Pandharpur (210 km)": "आळंदी ➔ पंढरपूर (210 किमी)",
  "Route 2:": "मार्ग 2:",
  "Dehu ➔ Pandharpur (218 km)": "देहू ➔ पंढरपूर (218 किमी)",
  "Confluence:": "संगम:",
  "Wakhri ➔ Pandharpur (96%)": "वाखरी ➔ पंढरपूर (96%)",
  "Origins:": "प्रारंभ स्थान:",
  "Alandi & Dehu Ghats (35%)": "आळंदी व देहू घाट (35%)",
  "Field Resource Checkpoints": "क्षेत्रीय संसाधन तपासणी नाके",
  "Palkhi Lead:": "पालखी आघाडी:",
  "Wakhri Phata (Km 184)": "वाखरी फाटा (कि.मी. 184)",
  "Medical Ambulances:": "वैद्यकीय रुग्णवाहिका:",
  "Saswad, Wakhri & Mandir": "सासवड, वाखरी व मंदिर",
  "Water Tankers:": "पाण्याचे टँकर:",
  "Wakhri & Pandharpur Base": "वाखरी व पंढरपूर तळ",
  "Police Patrol Squads:": "पोलीस गस्त पथके:",
  "PS-01 to PS-14": "PS-01 ते PS-14",
  "ROUTE 1": "मार्ग 1",
  "Sant Dnyaneshwar Maharaj Palkhi:": "संत ज्ञानेश्वर महाराज पालखी:",
  "Alandi ➔ Pune (Hadapsar) ➔ Saswad ➔ Lonand ➔ Phaltan ➔ Malshiras ➔ Wakhri ➔ Pandharpur (210 km)": "आळंदी ➔ पुणे (हडपसर) ➔ सासवड ➔ लोणंद ➔ फलटण ➔ माळशिरस ➔ वाखरी ➔ पंढरपूर (210 किमी)",
  "ROUTE 2": "मार्ग 2",
  "Sant Tukaram Maharaj Palkhi:": "संत तुकाराम महाराज पालखी:",
  "Dehu ➔ Pune (Nana Peth) ➔ Yavat ➔ Baramati ➔ Indapur ➔ Akluj ➔ Wakhri ➔ Pandharpur (218 km)": "देहू ➔ पुणे (नाना पेठ) ➔ येवत ➔ बारामती ➔ इंदापूर ➔ आकलूज ➔ वाखरी ➔ पंढरपूर (218 किमी)",
  "3 Active Cases": "3 सक्रिय प्रकरणे",
  "Automated facial matching engine active": "स्वयंचलित चेहरा जुळणी प्रणाली कार्यरत",
  "Medical Emergencies": "वैद्यकीय आणीबाणी",
  "2 Active Alerts": "2 सक्रिय इशारे",
  "Sector 3 (Wakhri) & Sector 5 (Pandharpur)": "विभाग 3 (वाखरी) व विभाग 5 (पंढरपूर)",
  "Resource Deployment": "संसाधन तैनाती",
  "3 / 7 Deployed": "3 / 7 तैनात",
  "Tankers, Ambulances & Patrol Squads stationed": "टँकर, रुग्णवाहिका व गस्त पथके तैनात",
  "PUBLIC PA BROADCAST": "सार्वजनिक पीए प्रसारण",
  "MARATHI • ENG": "मराठी • इंग्रजी",
  "Broadcast urgent crowd advisories across temple chowki loudspeakers.": "मंदिर चौकीच्या ध्वनिक्षेपकांवरून तातडीच्या गर्दी सूचना प्रसारित करा.",
  "+ Queue PA": "+ पीए रांगेत टाका",
  "Active Broadcast:": "सक्रिय प्रसारण:",
  "Real-time crowd alert & route advisory system": "रिअल-टाइम गर्दी इशारा व मार्ग सूचना प्रणाली",
  "CCTV SURVEILLANCE & CHECKPOINT FEEDS (4 CHANNELS)": "सीसीटीव्ही सर्वेक्षण व तपासणी नाका फीड (4 वाहिन्या)",
  "4 Channels • 1080p AI Surveillance": "4 वाहिन्या • 1080p एआय सर्वेक्षण",
  "INCIDENT LOG": "घटना नोंदवही",
  "[LIVE] VariSetu Command Center connected • Telemetry initialized.": "[थेट] VariSetu कमांड सेंटर जोडले गेले • टेलीमेट्री सुरू.",
  "Zone Density Analytics & Congestion Forecast": "विभाग घनता विश्लेषण व गर्दी अंदाज",
  "Crowd Density Monitoring across 6 Primary Pilgrimage Zones": "6 प्रमुख यात्रा विभागांमध्ये गर्दी घनता निरीक्षण",
  "ZONE-WISE CROWD DENSITY TABLE": "विभागनिहाय गर्दी घनता तक्ता",
  "UPDATED: LIVE TELEMETRY": "अद्ययावत: थेट टेलीमेट्री",
  "Zone Name": "विभागाचे नाव",
  "Density %": "घनता %",
  "Trend": "कल",
  "Recommended Action": "शिफारस केलेली कृती",
  "2-HOUR CONGESTION FORECAST MODEL": "2-तास गर्दी अंदाज प्रारूप",
  "Predicted crowd accumulation at Wakhri Phata & Pandharpur Chowk (19:00 - 21:00 IST)": "वाखरी फाटा व पंढरपूर चौकात अपेक्षित गर्दी संचय (19:00 - 21:00 IST)",
  "AI CCTV FRAME DENSITY ESTIMATION MODEL (CSRNET)": "एआय सीसीटीव्ही फ्रेम घनता अंदाज प्रारूप (CSRNET)",
  "Select CCTV camera feed or drag-and-drop a high-density frame:": "सीसीटीव्ही कॅमेरा फीड निवडा किंवा उच्च-घनतेची फ्रेम ड्रॅग-अँड-ड्रॉप करा:",
  "CAM-04 (Pandharpur Temple Chowk)": "CAM-04 (पंढरपूर मंदिर चौक)",
  "CAM-12 (Wakhri Phata Junction)": "CAM-12 (वाखरी फाटा जंक्शन)",
  "CAM-08 (Saswad Highway Stop)": "CAM-08 (सासवड महामार्ग थांबा)",
  "CAM-01 (Alandi Corridor)": "CAM-01 (आळंदी मार्गिका)",
  "Analyze Density": "घनता विश्लेषण करा",
  "CCTV Frame": "सीसीटीव्ही फ्रेम",
  "Drop Image Here": "प्रतिमा येथे टाका",
  "- or -": "- किंवा -",
  "Click to Upload": "अपलोड करण्यासाठी क्लिक करा",
  "Active source: Live CCTV Frame Buffer": "सक्रिय स्रोत: थेट सीसीटीव्ही फ्रेम बफर",
  "Estimated Devotees:": "अंदाजे भाविक:",
  "630 People": "630 लोक",
  "CRITICAL": "गंभीर",
  "Density Congestion Load": "घनता गर्दी भार",
  "85% of zone threshold": "विभाग मर्यादेच्या 85%",
  "Recommended Action:": "शिफारस केलेली कृती:",
  "Divert pedestrian flow to North Ring Road bypass.": "पादचारी प्रवाह उत्तर रिंग रोड बायपासकडे वळवा.",
  "Model:": "प्रारूप:",
  "● Model Ready": "● प्रारूप सज्ज",
  "Lost & Found Incident Desk": "हरवले-सापडले घटना कक्ष",
  "Citizen Helpline Call (नागरीक मदत)": "नागरिक हेल्पलाइन कॉल",
  "Register New Case": "नवीन प्रकरण नोंदवा",
  "AI FACE MATCH CANDIDATES": "एआय चेहरा जुळणी उमेदवार",
  "Page 1 of 1": "पृष्ठ 1 पैकी 1",
  "« Prev": "« मागील",
  "Next »": "पुढील »",
  "AI BIOMETRIC FACE RECOGNITION & PERSON RE-ID (MODELS 3A & 3B)": "एआय बायोमेट्रिक चेहरा ओळख व व्यक्ती पुनर्ओळख (प्रारूप 3A व 3B)",
  "Query crop": "शोध क्रॉप",
  "Use Sample": "नमुना वापरा",
  "No file selected": "कोणतीही फाइल निवडलेली नाही",
  "Gallery crop": "गॅलरी क्रॉप",
  "Run Biometric Compare": "बायोमेट्रिक तुलना करा",
  "Pending": "प्रलंबित",
  "Face Cosine Sim (InsightFace):": "चेहरा कोसाइन साम्य (InsightFace):",
  "Person Re-ID Sim (OSNet):": "व्यक्ती पुनर्ओळख साम्य (OSNet):",
  "Calibration Thresholds:": "कॅलिब्रेशन मर्यादा:",
  "Verdict:": "निष्कर्ष:",
  "Ready for verification pair comparison. Select or upload query & CCTV candidate images.": "पडताळणी जोडी तुलनेसाठी सज्ज. शोध व सीसीटीव्ही उमेदवार प्रतिमा निवडा किंवा अपलोड करा.",
  "All Statuses (सर्व)": "सर्व स्थिती",
  "Searching (शोध सुरू)": "शोध सुरू",
  "Match Found (सापडला)": "जुळणी सापडली",
  "Reunited (एकत्र आले)": "पुन्हा भेट झाली",
  "100 Cases": "100 प्रकरणे",
  "Photo": "छायाचित्र",
  "Case ID": "प्रकरण क्रमांक",
  "Name": "नाव",
  "Age / Gender": "वय / लिंग",
  "Clothing Description (Marathi & Eng)": "पोशाख वर्णन (मराठी व इंग्रजी)",
  "Last Seen Cam": "शेवटचा दिसलेला कॅमेरा",
  "Status": "स्थिती",
  "Action": "कृती",
  "Showing 1-15 of 100 cases": "100 पैकी 1-15 दाखवत आहे",
  "CALL-TO-CASE PIPELINE TRANSCRIPT": "कॉल-ते-प्रकरण प्रक्रिया उतारा",
  "Helpline 112 Audio Recording Snippet (Deccan Dialect) • Select a case": "हेल्पलाइन 112 ऑडिओ रेकॉर्डिंग तुकडा (देशी बोली) • एक प्रकरण निवडा",
  "Select a case to view call details and audio transcription.": "कॉल तपशील व ऑडिओ उतारा पाहण्यासाठी प्रकरण निवडा.",
  "Dispatch Nearby Volunteer": "जवळचा स्वयंसेवक पाठवा",
  "Queue PA Announcement": "पीए घोषणा रांगेत टाका",
  "Medical Emergencies & Heat-Risk Monitoring": "वैद्यकीय आणीबाणी व उष्णता-जोखीम निरीक्षण",
  "Active Field Ambulances & Emergency Medical Response Hubs": "सक्रिय क्षेत्रीय रुग्णवाहिका व आणीबाणी वैद्यकीय प्रतिसाद केंद्रे",
  "+ Report Medical Emergency": "+ वैद्यकीय आणीबाणी नोंदवा",
  "ACTIVE MEDICAL ALERTS": "सक्रिय वैद्यकीय इशारे",
  "LIVE FEED": "थेट फीड",
  "HEAT-RISK COMPUTED READOUT": "उष्णता-जोखीम गणित निष्कर्ष",
  "Ambient Temperature:": "परिसर तापमान:",
  "Relative Humidity:": "सापेक्ष आर्द्रता:",
  "Computed Risk Index:": "गणित जोखीम निर्देशांक:",
  "7.8 / 10 (MODERATE HEAT RISK)": "7.8 / 10 (मध्यम उष्णता जोखीम)",
  "Water Stations Active:": "सक्रिय पाणी केंद्रे:",
  "12 Operational": "12 कार्यरत",
  "ORSL Sachet Supplies:": "ओआरएसएल पाकीट पुरवठा:",
  "14,200 Packets Available": "14,200 पाकिटे उपलब्ध",
  "Advisory Action:": "सूचना कृती:",
  "Trigger mist sprayer vans at Wakhri Junction & increase water distribution post deployment by 20%.": "वाखरी जंक्शन येथे मिस्ट स्प्रेअर व्हॅन कार्यान्वित करा व तैनातीनंतर पाणी वाटप 20% ने वाढवा.",
  "AI FALL & CHOKEPOINT STAMPEDE DETECTOR (MODEL 2)": "एआय पडझड व चेंगराचेंगरी शोधक (प्रारूप 2)",
  "Select CCTV video feed or drag-and-drop a tracked clip:": "सीसीटीव्ही व्हिडिओ फीड निवडा किंवा ट्रॅक केलेली क्लिप ड्रॅग-अँड-ड्रॉप करा:",
  "CAM-04 (Pandharpur Temple Chowk Feed)": "CAM-04 (पंढरपूर मंदिर चौक फीड)",
  "CAM-12 (Wakhri Phata Feed)": "CAM-12 (वाखरी फाटा फीड)",
  "CAM-08 (Saswad Highway Checkpoint)": "CAM-08 (सासवड महामार्ग तपासणी नाका)",
  "CAM-01 (Alandi Starting Corridor)": "CAM-01 (आळंदी प्रारंभ मार्गिका)",
  "Analyze Fall": "पडझड विश्लेषण करा",
  "CCTV Video Clip": "सीसीटीव्ही व्हिडिओ क्लिप",
  "Drop Video Here": "व्हिडिओ येथे टाका",
  "Active source: CCTV Stream Ingestion Buffer": "सक्रिय स्रोत: सीसीटीव्ही स्ट्रीम बफर",
  "✅ No Fall Detected": "✅ पडझड आढळली नाही",
  "Risk: 12%": "जोखीम: 12%",
  "Fall Probability (Threshold: 42%)": "पडझड शक्यता (मर्यादा: 42%)",
  "Medical Action:": "वैद्यकीय कृती:",
  "Normal movement posture detected. Maintain active camera polling.": "सामान्य हालचाल आढळली. सक्रिय कॅमेरा निरीक्षण सुरू ठेवा.",
  "Inference:": "अनुमान:",
  "+ Dispatch Ambulance": "+ रुग्णवाहिका पाठवा",
  "Resource Fleet & Logistics": "संसाधन ताफा व रसद",
  "Corridor Fleet Units, Automated Recommendations & Action Timeline": "मार्गिका ताफा घटक, स्वयंचलित शिफारसी व कृती कालरेषा",
  "All Modules": "सर्व विभाग",
  "Dispatch & Route Recommendations": "प्रेषण व मार्ग शिफारसी",
  "Field Fleet Inventory": "क्षेत्रीय ताफा साठा",
  "Route Status & Diversions": "मार्ग स्थिती व वळणे",
  "Dispatch History": "प्रेषण इतिहास",
  "Action Timeline": "कृती कालरेषा",
  "All Categories": "सर्व प्रकार",
  "Water Tankers": "पाण्याचे टँकर",
  "Medical Units": "वैद्यकीय घटक",
  "Police Patrols": "पोलीस गस्त",
  "Volunteer Teams": "स्वयंसेवक चमू",
  "All Statuses": "सर्व स्थिती",
  "Available": "उपलब्ध",
  "Dispatched": "पाठवले",
  "DISPATCH & ROUTE RECOMMENDATIONS": "प्रेषण व मार्ग शिफारसी",
  "Active Queue": "सक्रिय रांग",
  "FIELD LOGISTICS & FLEET UNITS": "क्षेत्रीय रसद व ताफा घटक",
  "80 Units Managed": "80 घटक व्यवस्थापित",
  "ROUTE STATUS & CORRIDOR DIVERSION CONTROL": "मार्ग स्थिती व मार्गिका वळण नियंत्रण",
  "NH-60 Corridor": "NH-60 मार्गिका",
  "RESOURCE ALLOCATION & DISPATCH HISTORY": "संसाधन वाटप व प्रेषण इतिहास",
  "6 Active": "6 सक्रिय",
  "Timestamp": "वेळनोंद",
  "Resource Unit": "संसाधन घटक",
  "Capacity": "क्षमता",
  "Corridor Sector": "मार्गिका विभाग",
  "Stationed Checkpoint": "तैनात तपासणी नाका",
  "Mission": "कार्य",
  "LOGISTICS ACTION TIMELINE": "रसद कृती कालरेषा",
  "ALL": "सर्व",
  "DISPATCH": "प्रेषण",
  "ROUTE": "मार्ग",
  "PA": "पीए",
  "MEDICAL": "वैद्यकीय",
  "VARISETU COMMAND CENTER": "VARISETU कमांड सेंटर",
  "CCTV CAMERA EXPANDED VIEW": "सीसीटीव्ही कॅमेरा विस्तारित दृश्य",
  "PTZ Control": "PTZ नियंत्रण",
  "Close Window": "विंडो बंद करा",
  "Operational Alerts": "कार्यान्वयन इशारे",
  "3 Unread Alerts": "3 न वाचलेले इशारे",
  "Mark All Read": "सर्व वाचले म्हणून चिन्हांकित करा",
  "PUBLIC ADDRESS SYSTEM": "सार्वजनिक ध्वनी प्रणाली",
  "Queue Bilingual PA Announcement": "द्विभाषिक पीए घोषणा रांगेत टाका",
  "Announcement Message (मराठी)": "घोषणा संदेश (मराठी)",
  "Announcement Message (English)": "घोषणा संदेश (इंग्रजी)",
  "Category": "प्रकार",
  "Crowd Safety & Advisory": "गर्दी सुरक्षा व सूचना",
  "Route Diversion Notice": "मार्ग वळण सूचना",
  "Missing Pilgrim Announcement": "हरवलेला भाविक घोषणा",
  "Medical Camp Alert": "वैद्यकीय शिबिर इशारा",
  "Priority": "प्राधान्य",
  "High Priority": "उच्च प्राधान्य",
  "Critical Emergency": "गंभीर आणीबाणी",
  "Normal Advisory": "सामान्य सूचना",
  "Cancel": "रद्द करा",
  "Submit for Commander Approval": "कमांडर मंजुरीसाठी सादर करा",
  "GIS MAP ENGINE": "जीआयएस नकाशा इंजिन",
  "Configure Map Engine & API Key": "नकाशा इंजिन व एपीआय की कॉन्फिगर करा",
  "VariSetu uses high-performance dual map rendering. You can use Clean OpenStreetMap tiles (default) or Google Maps Platform vector map tiles.": "VariSetu उच्च-कार्यक्षमता दुहेरी नकाशा रेंडरिंग वापरते. आपण क्लीन OpenStreetMap टाइल्स (मूलभूत) किंवा Google Maps Platform वेक्टर नकाशा टाइल्स वापरू शकता.",
  "Active Map Provider": "सक्रिय नकाशा पुरवठादार",
  "Clean OpenStreetMap (Default - Offline Resilient)": "क्लीन OpenStreetMap (मूलभूत - ऑफलाइन सक्षम)",
  "Google Maps Platform Vector Engine (Cloud)": "Google Maps Platform वेक्टर इंजिन (क्लाउड)",
  "Google Maps JavaScript API Key": "Google Maps JavaScript एपीआय की",
  "Requires Maps JavaScript API & Places Library enabled.": "Maps JavaScript API व Places Library सक्रिय असणे आवश्यक आहे.",
  "Save & Apply Map Engine": "नकाशा इंजिन जतन करा व लागू करा",
  "WARI PILGRIMAGE CORRIDORS": "वारी यात्रा मार्गिका",
  "Pilgrimage Corridor Origins & Terminals": "यात्रा मार्गिका प्रारंभ व अंतिम स्थाने",
  "Route 1 Origin: Alandi Devsthan (Sant Dnyaneshwar Palkhi)": "मार्ग 1 प्रारंभ: आळंदी देवस्थान (संत ज्ञानेश्वर पालखी)",
  "Route: Alandi ➔ Saswad ➔ Lonand ➔ Phaltan ➔ Malshiras ➔ Wakhri ➔ Pandharpur (210 km)": "मार्ग: आळंदी ➔ सासवड ➔ लोणंद ➔ फलटण ➔ माळशिरस ➔ वाखरी ➔ पंढरपूर (210 किमी)",
  "Route 2 Origin: Dehu Devsthan (Sant Tukaram Palkhi)": "मार्ग 2 प्रारंभ: देहू देवस्थान (संत तुकाराम पालखी)",
  "Route: Dehu ➔ Pune ➔ Yavat ➔ Baramati ➔ Indapur ➔ Akluj ➔ Wakhri ➔ Pandharpur (218 km)": "मार्ग: देहू ➔ पुणे ➔ येवत ➔ बारामती ➔ इंदापूर ➔ आकलूज ➔ वाखरी ➔ पंढरपूर (218 किमी)",
  "Shared Destination: Pandharpur Vitthal Mandir": "समाईक गंतव्य: पंढरपूर विठ्ठल मंदिर",
  "Confluence Point: Wakhri Phata Ubhe Ringan (17.7280, 75.2950)": "संगम बिंदू: वाखरी फाटा उभे रिंगण (17.7280, 75.2950)",
  "Wari Corridor Profile:": "वारी मार्गिका माहिती:",
  "Live dual-route crowd density heatmap monitoring from Alandi & Dehu to Pandharpur.": "आळंदी व देहू ते पंढरपूर या दुहेरी मार्गावरील थेट गर्दी घनता हीटमॅप निरीक्षण.",
  "Close": "बंद करा",
  "Confirm Active Routes": "सक्रिय मार्ग निश्चित करा",
  "BIOMETRIC RE-ID PIPELINE": "बायोमेट्रिक पुनर्ओळख प्रक्रिया",
  "AI Biometric Discovery & Match Pipeline": "एआय बायोमेट्रिक शोध व जुळणी प्रक्रिया",
  "Maharashtra Police AI CCTV Re-Identification calibrated at": "महाराष्ट्र पोलीस एआय सीसीटीव्ही पुनर्ओळख यासाठी कॅलिब्रेट केली आहे",
  "0.1268 Cosine Distance Threshold": "0.1268 कोसाइन अंतर मर्यादा",
  "(97.28% LFW Benchmark Accuracy, 5% FPR).": "(97.28% LFW बेंचमार्क अचूकता, 5% FPR).",
  "HD Surveillance Video Ingestion": "एचडी सर्वेक्षण व्हिडिओ ग्रहण",
  "60 FPS CCTV feeds ingested from CAM-01, CAM-08, CAM-12, CAM-04 across NH-60 corridor.": "NH-60 मार्गिकेवरील CAM-01, CAM-08, CAM-12, CAM-04 येथून 60 FPS सीसीटीव्ही फीड ग्रहण केले जातात.",
  "Multi-Task MTCNN Facial Localization": "मल्टी-टास्क MTCNN चेहरा स्थानीकरण",
  "Real-time bounding box extraction, facial landmark alignment, and lighting compensation.": "रिअल-टाइम बाउंडिंग बॉक्स निष्कर्षण, चेहरा भूचिन्ह संरेखन व प्रकाश भरपाई.",
  "512-Dimensional MobileNetV4 Embedding": "512-आयामी MobileNetV4 एम्बेडिंग",
  "Extracts normalized 512-D deep biometric feature vectors for robust low-light & crowd matching.": "कमी प्रकाश व गर्दीतील मजबूत जुळणीसाठी प्रमाणित 512-D सखोल बायोमेट्रिक वैशिष्ट्य वेक्टर काढते.",
  "Cosine Vector Comparison against Dossiers": "दस्तावेजांशी कोसाइन वेक्टर तुलना",
  "Compares live CCTV embeddings against active lost person dossiers (e.g. Maruti Kisan Shinde #LF-802).": "थेट सीसीटीव्ही एम्बेडिंगची सक्रिय हरवलेल्या व्यक्तींच्या नोंदींशी तुलना करते (उदा. मारुती किसन शिंदे #LF-802).",
  "Threshold Verification (Distance ≤ 0.1268)": "मर्यादा पडताळणी (अंतर ≤ 0.1268)",
  "Candidate flagged as high-confidence match (Confidence 94%, Similarity 0.89) at CAM-04 Pandharpur/Nashik.": "CAM-04 पंढरपूर/नाशिक येथे उमेदवार उच्च-विश्वासार्ह जुळणी म्हणून चिन्हांकित (विश्वासार्हता 94%, साम्य 0.89).",
  "Commander Verification & Squad #14 Ground Dispatch": "कमांडर पडताळणी व पथक #14 प्रत्यक्ष पाठवणी",
  "Inspector Vikram Jadhav (Squad #14) dispatched for on-ground verification & DPDP-compliant reunion.": "निरीक्षक विक्रम जाधव (पथक #14) यांना प्रत्यक्ष पडताळणी व DPDP-अनुरूप पुनर्भेटीसाठी पाठवण्यात आले.",
  "Acknowledge Pipeline": "प्रक्रिया मान्य करा",
  "DYNAMIC RESOURCE ALLOCATION": "गतिशील संसाधन वाटप",
  "Reassign Fleet Unit Sector": "ताफा घटक विभाग पुन्हा नेमा",
  "Resource Code / Name": "संसाधन क्रमांक / नाव",
  "Target Corridor Sector": "लक्ष्य मार्गिका विभाग",
  "Sector 1 (Pune ➔ Bhosari - 38% Flow)": "विभाग 1 (पुणे ➔ भोसरी - 38% प्रवाह)",
  "Sector 2 (Bhosari ➔ Manchar - 62% Flow)": "विभाग 2 (भोसरी ➔ मंचर - 62% प्रवाह)",
  "Sector 3 (Manchar ➔ Sangamner - 82% Heavy Flow)": "विभाग 3 (मंचर ➔ संगमनेर - 82% जास्त प्रवाह)",
  "Sector 4 (Sangamner ➔ Govind Nagar Nashik - 92% Critical Surge)": "विभाग 4 (संगमनेर ➔ गोविंद नगर नाशिक - 92% गंभीर वाढ)",
  "Operational Notes": "कार्यान्वयन टिपा",
  "Confirm Reassignment": "पुनर्नियुक्ती निश्चित करा",
  "TRAFFIC CORRIDOR CONTROL": "वाहतूक मार्गिका नियंत्रण",
  "Manage / Divert Route": "मार्ग व्यवस्थापित / वळवा",
  "Route Segment": "मार्ग विभाग",
  "Corridor Status Action": "मार्गिका स्थिती कृती",
  "OPEN (Normal Flow)": "खुला (सामान्य प्रवाह)",
  "DIVERTED (Bypass Assigned)": "वळवलेला (बायपास नेमलेला)",
  "CLOSED (Prohibited)": "बंद (प्रतिबंधित)",
  "EMERGENCY_ONLY (Ambulance / Police Access Only)": "केवळ-आणीबाणी (केवळ रुग्णवाहिका / पोलीस प्रवेश)",
  "Bypass / Diversion Path": "बायपास / वळण मार्ग",
  "Apply Corridor Control": "मार्गिका नियंत्रण लागू करा",
  "MAHARASHTRA POLICE COMMAND RECORDS": "महाराष्ट्र पोलीस कमांड नोंदी",
  "Unified Operational Incident Timeline & Audit Exporter": "एकत्रित कार्यान्वयन घटना कालरेषा व ऑडिट निर्यातक",
  "Real-time chronological audit trail of all crowd surges, lost persons, biometric matches, and dispatches.": "सर्व गर्दी वाढ, हरवलेल्या व्यक्ती, बायोमेट्रिक जुळणी व प्रेषणांचा रिअल-टाइम कालानुक्रमिक ऑडिट माग.",
  "📥 Export Operational Summary (Govt Report)": "📥 कार्यान्वयन सारांश निर्यात करा (शासकीय अहवाल)",
  "Timestamp (IST)": "वेळनोंद (IST)",
  "Details & Action Log": "तपशील व कृती नोंद",
  "EMERGENCY 112 CITIZEN HELPLINE INTAKE • नागरीक मदत केंद्र": "आणीबाणी 112 नागरिक हेल्पलाइन नोंदणी • नागरीक मदत केंद्र",
  "IDLE": "निष्क्रिय",
  "READY / STANDBY": "सज्ज / प्रतीक्षेत",
  "Dial-in Line: 1800-233-0099 (Wari Control Desk #04) • 16kHz PCM16 Stream & Indic Neural Pipeline": "डायल-इन लाइन: 1800-233-0099 (वारी नियंत्रण कक्ष #04) • 16kHz PCM16 स्ट्रीम व भारतीय न्यूरल प्रक्रिया",
  "1-Way Live Voice Call (थेट आवाज कॉल)": "एक-मार्गी थेट आवाज कॉल",
  "Preset Call Simulation (नमुना कॉल)": "पूर्वनिर्धारित कॉल सिम्युलेशन",
  "✍️ Custom Text Intake (मजकूर नोंद)": "✍️ सानुकूल मजकूर नोंद",
  "⚙️ Speech & Translation APIs": "⚙️ भाषण व भाषांतर एपीआय",
  "LIVE BROWSER AUDIO • Real Microphone Streaming (16kHz Mono PCM16)": "थेट ब्राउझर ऑडिओ • खरे मायक्रोफोन स्ट्रीमिंग (16kHz मोनो PCM16)",
  "Session: Initializing...": "सत्र: सुरू होत आहे...",
  "RECOMMENDED APIS FOR LIVE DECCAN MARATHI SPEECH TRANSLATION": "थेट देशी मराठी भाषण भाषांतरासाठी शिफारस केलेले एपीआय",
  "Deployment Ready": "तैनातीसाठी सज्ज",
  "National Language Translation Mission. Specialized for 22 Indian languages including rural Marathi and Konkani dialects. Integrated IndicASR + IndicTrans2 NMT.": "राष्ट्रीय भाषा भाषांतर अभियान. ग्रामीण मराठी व कोकणी बोलींसह 22 भारतीय भाषांसाठी विशेष. IndicASR + IndicTrans2 NMT समाकलित.",
  "Recommended for Govt Projects • bhashini.gov.in": "शासकीय प्रकल्पांसाठी शिफारसीत • bhashini.gov.in",
  "High-performance Indian voice model suite (Saaras ASR & Bulbul TTS). Ultra-low latency Marathi/Hindi speech transcription with streaming WebSocket support.": "उच्च-कार्यक्षमता भारतीय आवाज प्रारूप संच (Saaras ASR व Bulbul TTS). स्ट्रीमिंग वेबसॉकेट समर्थनासह अति-कमी विलंब मराठी/हिंदी भाषण उतारा.",
  "Ultra Fast Voice AI • sarvam.ai": "अति-जलद आवाज एआय • sarvam.ai",
  "State-of-the-art multilingual ASR with zero-shot Devanagari translation and automated JSON entity extraction for clothing, age, gender, and landmark tags.": "झिरो-शॉट देवनागरी भाषांतर व पोशाख, वय, लिंग आणि स्थळखूण टॅगसाठी स्वयंचलित JSON घटक निष्कर्षणासह अत्याधुनिक बहुभाषिक ASR.",
  "Global Multilingual • platform.openai.com": "जागतिक बहुभाषिक • platform.openai.com",
  "🌐 Google Cloud Speech-to-Text & Translate": "🌐 Google Cloud स्पीच-टू-टेक्स्ट व भाषांतर",
  "Enterprise `mr-IN` and `hi-IN` neural acoustic models with real-time bidirectional streaming recognition and Neural Machine Translation.": "रिअल-टाइम द्वि-मार्गी स्ट्रीमिंग ओळख व न्यूरल मशीन भाषांतरासह एंटरप्राइझ `mr-IN` व `hi-IN` न्यूरल ध्वनिक प्रारूपे.",
  "Enterprise SLA • cloud.google.com": "एंटरप्राइझ SLA • cloud.google.com",
  "Citizen Caller (नागरिक कॉलर)": "नागरिक कॉलर",
  "📱 Helpline Direct Line": "📱 हेल्पलाइन थेट लाइन",
  "Pandharpur Wari Sector": "पंढरपूर वारी विभाग",
  "📶 16kHz Web Audio": "📶 16kHz वेब ऑडिओ",
  "LIVE SPECTRUM": "थेट स्पेक्ट्रम",
  "Microphone (PCM16)": "मायक्रोफोन (PCM16)",
  "SILENCE": "शांतता",
  "Start Live Mic Voice": "थेट माइक आवाज सुरू करा",
  "Speaker: ON": "स्पीकर: चालू",
  "⏸️ Hold": "⏸️ थांबवा",
  "भाषा (Voice):": "भाषा (आवाज):",
  "English": "इंग्रजी",
  "Status: Standby": "स्थिती: प्रतीक्षेत",
  "End Call (कॉल संपवा)": "कॉल संपवा",
  "SELECT PRESET PILGRIMAGE CALL SCENARIOS (नमुना कॉल्स):": "पूर्वनिर्धारित यात्रा कॉल परिस्थिती निवडा:",
  "ENTER OR PASTE CUSTOM CITIZEN COMPLAINT / DISTRESS MESSAGE (मराठी / हिन्दी / English):": "सानुकूल नागरिक तक्रार / संकट संदेश टाइप करा किंवा पेस्ट करा (मराठी / हिंदी / इंग्रजी):",
  "Translate & Extract": "भाषांतर करा व काढा",
  "CITIZEN NATIVE SPEECH (मराठी / हिन्दी)": "नागरिकाचे मूळ भाषण (मराठी / हिंदी)",
  "Live Audio Transcription": "थेट ऑडिओ उतारा",
  "[Ready] Speak into microphone or select a scenario to start transcription...": "[सज्ज] उतारा सुरू करण्यासाठी मायक्रोफोनमध्ये बोला किंवा परिस्थिती निवडा...",
  "AI NEURAL TRANSLATION (ENGLISH)": "एआय न्यूरल भाषांतर (इंग्रजी)",
  "[AI Translation] English translation stream will populate synchronously...": "[एआय भाषांतर] इंग्रजी भाषांतर स्ट्रीम समकालिकपणे भरले जाईल...",
  "OPERATOR REPORT & CASE INTAKE • ऑपरेटर नोंदणी अहवाल": "ऑपरेटर अहवाल व प्रकरण नोंदणी • ऑपरेटर नोंदणी अहवाल",
  "Review & edit extracted details from citizen speech": "नागरिकाच्या भाषणातून काढलेले तपशील तपासा व संपादित करा",
  "Missing Person Full Name (व्यक्तीचे नाव)": "हरवलेल्या व्यक्तीचे पूर्ण नाव",
  "Age & Gender (वय व लिंग)": "वय व लिंग",
  "Female (स्त्री)": "स्त्री",
  "Male (पुरुष)": "पुरुष",
  "Other": "इतर",
  "Clothing & Appearance Details (पोशाख व वर्णन)": "पोशाख व दिसण्याचे तपशील",
  "Last Seen Landmark / Sector (शेवटचे पाहिलेले ठिकाण)": "शेवटचे पाहिलेले ठिकाण / विभाग",
  "Operator Incident Notes & Description (अधिकारी शेरा)": "ऑपरेटर घटना टिपा व वर्णन",
  "Distressed mother called stating child slipped away during sudden crowd surge on temple ghat steps. Immediate CCTV scan alerted.": "व्याकुळ आईने कॉल करून सांगितले की मंदिर घाटाच्या पायऱ्यांवर अचानक झालेल्या गर्दीत मूल हरवले. तात्काळ सीसीटीव्ही तपासणी सुरू केली.",
  "Pipeline:": "प्रक्रिया:",
  "1. Submit Report to create case • 2. AI CCTV Re-ID scan searches surveillance cameras.": "1. प्रकरण तयार करण्यासाठी अहवाल सादर करा • 2. एआय सीसीटीव्ही पुनर्ओळख तपासणी कॅमेऱ्यांचा शोध घेते.",
  "1. Submit Report & Create Case": "1. अहवाल सादर करा व प्रकरण तयार करा",
  "2. AI CCTV Re-ID Scan": "2. एआय सीसीटीव्ही पुनर्ओळख तपासणी",
  "AI CCTV CANDIDATE MATCHES DETECTED (सीटीव्ही कॅमेरा शोध निकाल)": "एआय सीसीटीव्ही उमेदवार जुळणी आढळली",
  "Matches Detected": "जुळणी आढळल्या",
  "End-to-End Pixel Resolution Inspector": "संपूर्ण पिक्सेल रिझोल्यूशन तपासणी",
  "1920 × 1080 px (100% Uncropped Scale)": "1920 × 1080 px (100% अक्रॉप्ड स्केल)",
  "× Close": "× बंद करा",
  "• Uncropped Edge-to-Edge Signal": "• अक्रॉप्ड एज-टू-एज सिग्नल",
  "• 100% Native Sensor Pixel Density": "• 100% मूळ सेन्सर पिक्सेल घनता",
  "• Zero Cropping / Full Aspect Ratio": "• शून्य क्रॉपिंग / संपूर्ण आस्पेक्ट रेशो",
  "Acknowledge": "मान्य करा",
  "Acknowledging...": "मान्य करत आहे...",
  "Acknowledgement Failed": "मान्यता अयशस्वी",
  "Remove": "काढा",
  "Pan Left": "डावीकडे फिरवा",
  "Pan Right": "उजवीकडे फिरवा",
  "Tilt Up": "वर कलवा",
  "Tilt Down": "खाली कलवा",
  "Zoom In": "झूम इन",
  "Zoom Out": "झूम आउट",
  "Save Snapshot": "स्नॅपशॉट जतन करा",
  "Toggle AI Bounding Boxes": "एआय बाउंडिंग बॉक्स टॉगल करा",
  "Center Reset": "मध्यभागी रीसेट करा",
  "Ambulance": "रुग्णवाहिका",
  "Click to inspect full pixel resolution": "पूर्ण पिक्सेल रिझोल्यूशन पाहण्यासाठी क्लिक करा",
  "Citizen Pilgrim": "नागरिक भाविक",
  ...
  function applyToTextNode(node) {
    if (!originalTextMap.has(node)) {
      ...
      if (!trimmed || lookup(trimmed) === undefined) return;
      originalTextMap.set(node, node.textContent);
    }
    var original = originalTextMap.get(node);
    var trimmed2 = original.trim();
    var translated = lookup(trimmed2);
    if (translated === undefined) return;
    node.textContent = currentLang === 'mr' ? original.replace(trimmed2, translated) : original;
  }
  ...
  function applyToElementAttrs(el) {
    ...
    for (var i = 0; i < TRANSLATABLE_ATTRS.length; i++) {
      ...
      var store = originalAttrMap.get(el);
      if (!store) { store = {}; originalAttrMap.set(el, store); }
      if (!(attr in store)) {
        var val = el.getAttribute(attr);
        if (lookup(val.trim()) === undefined) continue;
        store[attr] = val;
      }
      var originalVal = store[attr];
      if (originalVal === undefined) continue;
      var translatedVal = lookup(originalVal.trim());
      if (translatedVal === undefined) continue;
      el.setAttribute(attr, currentLang === 'mr' ? translatedVal : originalVal);
    }
  }
  ...
  function walk(root) {
    ...
    if (root.nodeType === 1) applyToElementAttrs(root);
    if (root.querySelectorAll) {
      var attrEls = root.querySelectorAll('[placeholder],[title],[aria-label]');
      for (var j = 0; j < attrEls.length; j++) applyToElementAttrs(attrEls[j]);
    }
  }

  function updateToggleButtonLabel() {
    var btn = document.getElementById('variSetuLangToggleBtn');
    if (!btn) return;
    btn.textContent = currentLang === 'mr' ? 'EN' : 'मराठी';
    btn.setAttribute('aria-label', currentLang === 'mr' ? 'Switch to English' : 'मराठीत बदला');
  }
  ...
  function setLanguage(lang) {
    ...
    walk(document.body);
    document.documentElement.setAttribute('lang', currentLang === 'mr' ? 'mr' : 'en');
    updateToggleButtonLabel();
  }

  function createToggleButton() {
    if (document.getElementById('variSetuLangToggleBtn')) return;
    var btn = document.createElement('button');
    btn.id = 'variSetuLangToggleBtn';
    btn.type = 'button';
    btn.className = 'varisetu-lang-toggle';
    btn.textContent = currentLang === 'mr' ? 'EN' : 'मराठी';
    btn.setAttribute('aria-label', currentLang === 'mr' ? 'Switch to English' : 'मराठीत बदला');
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initVariSetuI18n);
  } else {
    initVariSetuI18n();
  }
})();
